 ...
 */
package com.github.ansgrb.leaptechevents_android.domain.usecases
...
class BookTicketUseCase @Inject constructor(
    ...
    suspend operator fun invoke(eventId: String, userId: String): Ticket =
        ticketRepository.bookTicket(eventId, userId)
}
